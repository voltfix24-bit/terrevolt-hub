...
const defaults: State = {
  apps: [
    { id: uid(), name: "TerreVolt Planner", description: "Beheer planningen, ploegen en projectcapaciteit.", icon: "📅", category: "Operatie", href: "/planner", featured: true, newTab: false, accent: "brand" },
    { id: uid(), name: "Urenregistratie", description: "Boek snel en nauwkeurig uren op projecten.", icon: "⏱️", category: "Operatie", href: "/uren", featured: true, newTab: false, accent: "lime" },
    { id: uid(), name: "Aardingsrapporten", description: "Maak en beheer aardingsrapporten.", icon: "⚡", category: "Techniek", href: "/aarding", featured: false, newTab: false, accent: "pastel" },
    { id: uid(), name: "Materiaal Configurator", description: "Stel materialenlijsten samen voor projecten.", icon: "🧰", category: "Techniek", href: "/materiaal", featured: false, newTab: false, accent: "navy" },
    { id: uid(), name: "Haspelregistratie", description: "Registreer haspels, meterstanden en projectverbruik.", icon: "🔌", category: "Techniek", href: "/haspels", featured: false, newTab: false, accent: "brand" },
    { id: uid(), name: "SharePoint", description: "Open de centrale documentomgeving.", icon: "📁", category: "Documenten", href: "https://sharepoint.com", featured: false, newTab: true, accent: "pastel" },
  ],
  news: [
  ...
  quickLinks: [
    { id: uid(), name: "Outlook", href: "https://outlook.office.com", icon: "✉️" },
    { id: uid(), name: "Teams", href: "https://teams.microsoft.com", icon: "💬" },
    { id: uid(), name: "Intranet", href: "https://sharepoint.com", icon: "🏠" },
  ],
  knowledge: [
    { id: uid(), slug: "werkvoorbereiding", name: "Werkvoorbereiding", description: "Procedures, checklists en templates.", icon: "📋" },
    { id: uid(), slug: "veiligheid", name: "Veiligheid", description: "Veiligheidsinstructies en VCA.", icon: "🦺" },
    { id: uid(), slug: "bei", name: "BEI", description: "Bedrijfsvoering elektrische installaties.", icon: "⚡" },
    { id: uid(), slug: "aarding", name: "Aarding", description: "Richtlijnen en meetmethodes.", icon: "🌍" },
    { id: uid(), slug: "ls-meten", name: "LS Meten", description: "Laagspanning meetprocedures.", icon: "📏" },
    { id: uid(), slug: "materialen", name: "Materialen", description: "Specificaties en leveranciers.", icon: "🧰" },
